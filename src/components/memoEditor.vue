<template>
  <div>
    <div id="new-markdown" class="editor-layer">
      <div class="editor-top">
        ...
        <div class="dropdown select-category">
          ...
          <ul class="dropdown-menu">
            <li @click="newMarkdown.categoryId = 1">
              <a>工作</a>
            </li>
            <li @click="newMarkdown.categoryId = 2">
              <a>生活</a>
            </li>
            <li @click="newMarkdown.categoryId = 3">
              <a>学习</a>
            </li>
          </ul>
        </div>
      ...
      <textarea class="text-content form-control" placeholder="内容" v-model="newMarkdown.content"></textarea>
    </div>
    ...
    <div id="new-doodle" class="editor-layer">
      <div class="editor-top">
        ...
        <div class="dropdown select-category">
          ...
          <ul class="dropdown-menu">
            <li @click="newDoodle.categoryId = 1">
              <a>工作</a>
            </li>
            <li @click="newDoodle.categoryId = 2">
              <a>生活</a>
            </li>
            <li @click="newDoodle.categoryId = 3">
              <a>学习</a>
            </li>
          </ul>
        </div>
